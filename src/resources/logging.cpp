...
void Logging::Initialize()
{
    ...
    // spdlog initialisation
    {
        try
        {
            ...
            Util::CheckForASIFiles(sFixName, true, true, nullptr); //Sets sFixPath. Exit thread & warn the user if multiple copies of MGS-SafetyHookBase are trying to initialize.
