...
void ASILoaderCompatibility::Check()
{
    ...
    if ((eGameType & (LAUNCHER|MGS3)) && Util::CheckForASIFiles("KeepAiming", false, false, "2025-07-15"))
    {
        std::string message =
            ...
            "the game to crash with the latest versions of MGS-SafetyHookBase.\n\n"
            ...
            "the latest versions of MGS-SafetyHookBase (until they can update their mod.)\n\n";
        ...
        int result = MessageBoxA(
            nullptr,
            message.c_str(),
            "MGS-SafetyHookBase Mod Compatibility Alert",
            MB_ICONERROR | MB_OK
        );
        spdlog::error("MOD COMPATIBILITY ALERT: The detected version of KeepAiming.asi is outdated and causes the game to crash with the latest versions of MGS-SafetyHookBase.");
        ...
        spdlog::error("MOD COMPATIBILITY ALERT: Please remove KeepAiming.asi from your game directory to use the latest versions of MGS-SafetyHookBase (until they can update their mod.)");
